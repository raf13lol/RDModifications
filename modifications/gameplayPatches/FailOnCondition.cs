...
public class FailOnCondition : Modification
{
    ...
    public class ResetFailedYetPatch
    {
    ...
    public class RankMistakesFailConditionsPatch
    {
    ...
    public class MissesFailConditionPatch
    {
    ...
    public class HeartbreakerFailConditionPatch
    {
