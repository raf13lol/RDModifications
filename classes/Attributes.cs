...
public class ConfigurationAttribute<T>(T defaultValue, string description, T[] acceptableRange = null, bool setAsConfigValue = false) : Attribute where T : IComparable
{
    ...
    public bool SetAsConfigValue = setAsConfigValue;
