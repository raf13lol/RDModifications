...
public class RemoveFourRowLimit : Modification
{
    ...
    public class CreateRowHeadersPatch
    {
    ...
    public class ApplyNewMaxUsedYPatch
    {
    ...
    public class UsedRowCountPatch
    {
    ...
    public class UpdateUI16RowHeadersPatch
    {
        public static void ILManipulator(ILContext il)
        {
            ILCursor cursor = new(il);
    ...
    public class RowHeaderUpdateUIPatch
    {
    ...
    public class RowHeaderUpdateScrollbarAddPatch
    {
        public static void Postfix(RowHeader __instance)
            => __instance.timeline.UpdateMaxUsedY();
    }
    ...
    public class RoomDropdownWasUpdatedPatch
    {
        public static void ILManipulator(ILContext il)
        {
            ILCursor cursor = new(il);
    ...
    public class UpdateRoomDropdownPatch
    {
        public static void ILManipulator(ILContext il)
        {
            ILCursor cursor = new(il);
